			...
			<div class="question_container common_middle">
				<div class="qutesiton_content">
					...
					<ul class="answer_list">
						<li class="answer_list_item" v-for="(item,index) in questionList[questionNum-1].topic_answer"
							@click="chooseItem(index,item.topic_answer_id)"
							>
							<!--ABCD-->
	...
	export default{
		data(){
			return{
				...
				//questionList[questionNum-1].topic_name,
				myanswer:null,
				myanswerId:null
